        ...
        <div className="w-full lg:w-1/2">
          <div className="flex flex-col items-center lg:items-start">
            <motion.h1
              ...
              initial="hidden"
              animate="visible"
              className="pb-14 lg:pb-15 text-3xl md:text-5xl font-thin tracking-tight lg:mt-12 lg:text-7xl"
            >
              Mahesha Piyumantha
            </motion.h1>
            <motion.span
            ...
            <motion.p
              ...
              initial="hidden"
              animate="visible"
              className="my-2 max-w-xl py-6 text-sm lg:text-lg tracking-tighter leading-8 lg:leading-10"
            >
              {HERO_CONTENT}
            </motion.p>
          </div>
